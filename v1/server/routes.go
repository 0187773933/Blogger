...
func ( s *Server ) SetupRoutes() {
	...
	s.FiberApp.Get( "/page/delete" , private_limiter , validate_session_mw , s.PageDelete )
	...
	s.FiberApp.Get( "/page/get/all" , private_limiter , validate_session_mw , s.PageGetAll )
